...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/data-input'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: DataInput) {
        return item.id;
    }
    registerChangeInDataInputs() {
        this.eventSubscriber = this.eventManager.subscribe('dataInputListModification', (response) => this.loadAll());
    }
