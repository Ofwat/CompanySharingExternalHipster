...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/data-bundle'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: DataBundle) {
        return item.id;
    }
    registerChangeInDataBundles() {
        this.eventSubscriber = this.eventManager.subscribe('dataBundleListModification', (response) => this.loadAll());
    }
