    ...
    public RefreshingUserDetailsSecurityContextRepository refreshingUserDetailsSecurityContextRepository(HttpSessionSecurityContextRepository httpSessionSecurityContextRepository) {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            http
                ...
                .antMatchers("/api/company-data-inputs/**").hasAnyAuthority(AuthoritiesConstants.OFWAT_ADMIN, AuthoritiesConstants.COMPANY_ADMIN,AuthoritiesConstants.COMPANY_USER)
                .antMatchers("/api/company-data-collections/**").hasAnyAuthority(AuthoritiesConstants.OFWAT_ADMIN, AuthoritiesConstants.COMPANY_ADMIN,AuthoritiesConstants.COMPANY_USER)
                .antMatchers("/api/company-data-bundles/**").hasAnyAuthority(AuthoritiesConstants.OFWAT_ADMIN, AuthoritiesConstants.COMPANY_ADMIN, AuthoritiesConstants.COMPANY_USER)
