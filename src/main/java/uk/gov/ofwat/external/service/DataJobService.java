...
import uk.gov.ofwat.external.repository.RejectionRepository;
...
public class DataJobService {
    ...
    public DataJob createDataJob(CompanyDataInput companyDataInput, TableDto tableDto) {
        ...
        dataJob.setCompanyId("" + companyDataInput.getCompany().getFountainId());
        ...
        dataJob.setRunId("0");
        dataJob.setRejectionCodes(rejectionRepository.findOne(new Long(1)));
